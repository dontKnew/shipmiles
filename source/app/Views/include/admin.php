...
<!--                --><?php //= strtoupper("SHIPMILES"); ?>
                <img src="https://www.shipmiles.com/assets/img/Logo.png" width="200" class="img-fluid">
            </a>
                ...
                <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <a class="dropdown-item text-center" href="<?= route_to("admin/logout") ?>"><i class="fa fa-power-off"></i> Logout</a>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
                </ul>
    ...
    <div class="sidebar">
        <div class="scrollbar-inner sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="nav-item <?php if(isset($packageType) ){ echo $packageType;} ?>">
                    <a href="<?= route_to("admin/package-type") ?>">
                        <i class="la la-table"></i>
                        <p>Package</p>
                        <span class="badge badge-info"><?php if(isset($packageType)): echo esc($packageType); endif; ?></span>
                    </a>
                </li>

                <li class="nav-item <?php if(isset($service) ){ echo $service;} ?>">
                    <a href="<?= route_to("admin/service") ?>">
                        <i class="la la-table"></i>
                        <p>Service</p>
                        <span class="badge badge-info"><?php if(isset($service)): echo esc($service); endif; ?></span>
                    </a>
                </li>

                <li class="nav-item <?php if(isset($ratelist) ){ echo $ratelist;} ?>">
                    <a href="<?= route_to("admin/ratelist") ?>">
                        <i class="la la-table"></i>
                        <p>Ratelist</p>
                        <span class="badge badge-info"><?php if(isset($ratelist)): echo esc($ratelist); endif; ?></span>
                    </a>
                </li>

                <li class="nav-item <?php if(isset($country) ){ echo $country;} ?>">
                    <a href="<?= route_to("admin/country") ?>">
                        <i class="la la-table"></i>
                        <p>Country</p>
                        <span class="badge badge-info"><?php if(isset($country)): echo esc($country); endif; ?></span>
                    </a>
                </li>
                ...
                <li class="nav-item <?php if(isset($change_password) ){ echo $change_password;} ?>">
                    <a href="<?= route_to("admin/change-password") ?>">
                        <i class="la la-lock"></i>
                        <p>Change Password</p>
                    </a>
                </li>
                <a href="<?= route_to("admin/logout") ?>" alt="logout button" class="mx-4 my-4 btn btn-sm btn-outline-danger d-flex justify-content-center align-items-center">
