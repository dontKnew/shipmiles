    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="card-title">Manage Package Type</div>
                <a href="<?= route_to("admin/package-type/add") ?>" class="btn btn-info">
                    <i class="la la-plus-circle"></i> Add Package Type
                </a>
            </div>
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <?php if ($data): ?>
                    <form action="<?= route_to("admin/package-type") ?>" method="post" >
                        ...
                        <table class="table table-head-bg-primary table-striped table-hover text-center">
                            ...
                            <?php $i=1; foreach ($data as $value): ?>
                                <tr>
                                    ...
                                    <td><?= esc($value['sort_order']) ?></td>
                                    <td>
                                        <a onclick="return confirm('Are you sure want to remove package-type ?')" href="<?= route_to("admin/package-type/delete", $value['id']) ?>"
                                           class="btn btn-sm btn btn-rounded btn-danger my-1">
                                            <i class="la la-trash"></i> Delete
                                        </a>
                                        <a href="<?= route_to("admin/package-type/update" , $value['id']) ?>"
